                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Өнөөдрийн үйл явдал</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $todayEventsCount }}</div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Энэ сарын үйл явдал</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $monthEventsCount }}</div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                        Хамгийн их хандалттай</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $popularEventViews }}</div>
                                </div>
                                <div class="col-auto">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.10.2/locale/mn.js"></script>
