...
<div id="google_translate_element"></div>
    ...
    <!-- Google Translate -->
<!-- Google Translate Script Section -->
<script type="text/javascript">
    ...
    function googleTranslateElementInit() {
        ...
        // Set timeout to switch to Mongolian after Google Translate loads
        setTimeout(switchToMongolian, 2500);
    }

    // Function to set language to Mongolian
    function switchToMongolian() {
        try {
            var selectElement = document.querySelector('.goog-te-combo');
            if (selectElement) {
                selectElement.value = 'mn';
                selectElement.dispatchEvent(new Event('change'));
                console.log('Language switched to Mongolian');
            } else {
                console.error('Google Translate selector not found');
                // Try again after a delay if element not found
                setTimeout(switchToMongolian, 1000);
            }
        } catch (error) {
