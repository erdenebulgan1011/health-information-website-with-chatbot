...
<div id="map-container" class="w-full flex flex-col md:flex-row bg-white rounded shadow-sm" style="height: 300px; max-height: 300px;">
    <!-- Sidebar -->
    <div id="sidebar" class="w-full md:w-1/4 bg-white border-r border-gray-200 p-2 overflow-hidden flex flex-col" style="max-height: 300px;">
        <!-- Controls -->
        ...
        <!-- Places list -->
        <div class="place-list flex-grow overflow-y-auto mt-1" id="place-list" style="max-height: 210px;">
            <!-- Places will be listed here -->
        </div>
    </div>

    <!-- Map -->
    <div id="map" class="w-full md:w-3/4" style="height: 300px;"></div>
</div>

<!-- Loading indicator -->
<div class="loading fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50 hidden" id="loading">
    <div class="bg-white p-2 rounded-lg shadow-lg">
        <p class="text-gray-800 text-sm">Ачааллаж байна...</p>
    </div>
</div>
