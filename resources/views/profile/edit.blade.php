            ...
            <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-2">
                            <img src="{{ $profile->profile_pic_url }}" alt="Profile Picture" class="img-thumbnail" style="max-height: 150px;">
                            <a href="{{ route('profile.remove-pic') }}" class="btn btn-sm btn-danger ms-2"
                ...
                <div>
                    <label for="weight" class="block text-sm font-medium text-gray-700">Жин (кг)</label>
                    <input type="number" name="weight" id="weight" value="{{ old('weight', $profile->weight) }}" min="20" max="500" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('weight')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
