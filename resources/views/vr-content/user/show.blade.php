...
@section('title', 'Онцлох VR Загварууд')
                                    ...
                                    <div class="flex items-start">
                                        <div class="bg-gray-200 rounded-lg overflow-hidden w-24 h-24 flex-shrink-0">
                                            <div class="w-full h-full relative">
                                                <iframe
                                                    src="https://sketchfab.com/models/{{ $content->sketchfab_uid }}/embed?autospin=1&ui_theme=dark&ui_controls=0&ui_infos=0&ui_watermark=0"
                                                    title="{{ $content->title }}"
                                                    allowfullscreen
                                                    mozallowfullscreen="true"
                                                    webkitallowfullscreen="true"
